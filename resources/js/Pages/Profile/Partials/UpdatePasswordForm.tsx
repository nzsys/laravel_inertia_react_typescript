    ...
    return (
        <section className={className}>
            ...
            <form onSubmit={updatePassword} className="mt-6 space-y-6">
                <div>
                    <InputLabel forInput="current_password" value="現在のパスワード" />
                ...
                <div>
                    <InputLabel forInput="password" value="新しいパスワード" />
                ...
                <div>
                    <InputLabel forInput="password_confirmation" value="パスワードを再入力" />
