...
export default function BreadCrumbs({current, parent, uri}: Props) {
    return (
                ...
                {parent &&
                    <li>
                        <div className="flex items-center">
                            ...
                            <Link href={route(uri)} className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">
                                {parent}
                            </Link>
                        </div>
                    </li>
                ...
                {current &&
                    <li aria-current="page">
                        <div className="flex items-center">
                            ...
                            <span className="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{current}</span>
                        </div>
                    </li>
                }
            </ol>
